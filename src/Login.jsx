export default function Login() {
  return (
    <div className="container py-32 flex flex-col gap-32">
      ...
      {/* Form Content */}
      <div className="flex flex-col align-center gap-44">
        ...
        <div className="flex flex-col gap-16">
          ...
          <div className="flex flex-row gap-8">
            <img className="width-48" src="facebook.svg" alt="facebook logo" />
            <img className="width-48" src="github.svg" alt="Github logo" />
            <img className="width-48" src="linkedin.svg" alt="Linkedin logo" />
          </div>
        </div>
      </div>
    </div>
